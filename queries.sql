...
-- Many to Many [need to create a new table that connects the relation] -- 
CREATE TABLE class (
  id SERIAL PRIMARY KEY,
  title VARCHAR(45)
);
...
-- 1 user can visit many countries so its 1:M--
CREATE TABLE users(
...
--additional so no more than 1 country in a person--
